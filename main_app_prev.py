...
if "session_list" not in st.session_state:
    ...
    for i in range(10):
        st.session_state.session_list.append(
            {"session_name": f"session{i+1}", "conversation_id": f"conversation{i+1}"})
...
with st.sidebar:
    ...
    with session_tab:
        ...
        if st.button("Remove Session", use_container_width=True):
            ...
            def remove_dialog():
                ...
                with st.container(height=600, border=True):
                    ...
                    draw_session_button(
                        "e362a88b-e99c-4312-ac94-5e31dda0e042", on_session_button_clicked)
            ...
            def rename_dialog():
                if st.session_state.choose_session_id == -1:
                    ...
                    if st.button("Rename", use_container_width=True):
                        rename_conversation(
                            st.session_state.choose_session_id, new_session_name)
        ...
        with st.container(height=600, border=True):
            ...
            draw_session_button(
                "98296fec-185a-472c-9015-c2e5953cce43", on_session_button_clicked)
